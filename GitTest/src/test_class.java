...
import javafx.application.Application;
	...
	import javafx.application.*;
		...
		public class test_class extends Application {
...
//				static Button a = new Button("Go          ");
				static Image image = new Image("go.png");
	...
	@Override
		...
		hbBtn3.getChildren().add(iv1);
		hbBtn.getChildren().addAll(b, c, d, e, f);
		hbBtn2.getChildren().addAll(p, o, n, m, l, k);
		alskf.add(hbBtn, 0, 0);
		alskf.add(hbBtn2, 0, 5);
//			alskf.setHgap(10);

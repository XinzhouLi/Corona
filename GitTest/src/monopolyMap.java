...
public class monopolyMap {
    ...
    /**
     * Method will pick a random card from a digital pile and award the player with money.
     */
    ...
    /**
     * Method will allow player to purchase property.
     * @param a Of type Player taht holds info on who owns property and of how much info to code
     * @param b 
     */
    ...
    /**
     * Method will allow player to sell property.
     */
    ...
    /**
     * Method will allow player to transfer their own funds to another 
     * player.
     * @param a Type Player that holds info on money
     * @param c Type Player that holds info on money
     * @param k Type Player that holds info on money
     */
